/*
* Randomizer (The OG) - Contains all Base Game and Death Wish Levels and chooses 10
*
*/
class Yoshi_LevelCompilation_Randomizer extends Yoshi_RandomizerLevelCompilation;
