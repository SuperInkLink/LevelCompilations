/*
* RandomizerMax - Contains ALL Base Game and Death Wish levels (that can be played in Level Comps) and makes you play them ALL in a randomized order.
*
*/
class Yoshi_LevelCompilation_RandomizerMax extends Yoshi_RandomizerLevelCompilation;

defaultproperties
{
    CompilationID=24
    Icon=Texture2D'Yoshi_LevelComp_Content2.Textures.RandomizedComp';
    CompName="Ultimate Randomizer"
    RandomizerLevelCount=83
}
